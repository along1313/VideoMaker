...
class ScriptService:
    ...
    def generate_json_script_from_prompt(self, user_prompt: str, **config) -> str:
        ...
        system_prompt = """
        你是一个专业的文案写手，擅长根据用户需求创作优质的视频文案。视频形式为人声朗读配上播放静态插图，配以字幕。
        1. 人声朗读文本总字数不少于1200字，不超过5000字。如果用户的要求是视频时长，可以用每分钟等于80字来换算。
        ...
        8. 请先完成"vioce_text"部分，再根据"vioce_text"完成对应的分镜插页描述"image_description"，描述要跟"vioce_text"内容高度相关，然后再根据"image_description"设计人物"main_character_description"部分，在每个人物描述后面加上角色出场的分镜编号，比如：“角色描述...(该角色出现在分镜index:2,index:4)"
        ...
        {{
                ...
                "main_character_description": [
                    "...",
                ], # 主要角色视觉描述，包括人物，卡通角色等。进行外形、外貌、衣着、颜色等描写，请用具体的词汇描述，锁定外观，用于保持视觉前后一致性，描述要合理，符合大众一般认知。如果脚本无特定人物可以为空[]
                "content":[
                    {{
                        "index": "...", # 分镜编号，从0开始
                        "voice_text": "..." # 人声朗读文本
                        "image_description": "..." # 插页描述，要与"voice_text"内容高度相关，描述要合理，符合大众一般认知。
                    }},
                    ...
                ],
                "total_count": n # 总条数
            ...
            {{
                    ...
                    "content":[
                        {{
                            "index": "...", # 分镜编号，从0开始
                            "voice_text": "..." # 人声朗读文本
                            "image_description": "..." # 插页描述，要与"voice_text"内容高度相关，描述要合理，符合大众一般认知。画面不要出现文字。。
                        }},
                        ...
                    ],
                    "total_count": n # 总条数
